...
/**
 * Handle NetShort CDN requests using node:https
 * (fetch doesn't work well with their CDN)
 */
export function handleNetShort(urlStr: string, headers: Record<string, string>): Promise<Response> {
